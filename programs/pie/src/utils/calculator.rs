...
impl Calculator {
    ...
    pub fn normalize_decimal_v2(val: u64, token_decimal: u64, sys_decimal_value: u64) -> u128 {
        ...
        let ret_mut = Self::to_u128(val).unwrap()
            ...
            .unwrap();
        let ret = ret_mut
            .checked_div(10u128.checked_pow(Self::to_u32(token_decimal).unwrap()).unwrap())
            .unwrap();
        ret
    }

    pub fn restore_decimal(val: u128, token_decimal: u64, sys_decimal_value: u64) -> u128 {
        ...
        let ret_mut = val
            .checked_mul(10u128.checked_pow(Self::to_u32(token_decimal).unwrap()).unwrap())
            .unwrap();
