...
describe("pie", () => {
    ...
    it("Create Basket of CPMM token", async () => {
        ...
        const {
            vaults,
            tx: createBasketVaultTx
        } = await pieProgram.createBasketVaultAccounts(admin.publicKey, createBasketArgs, basketId)
    ...
    it("Buy Component", async () => {
        ...
        const {
            tokenAccount: nativeMintAta,
            tx
        } = await getOrCreateNativeMintATA(connection, admin.publicKey, admin.publicKey)
    ...
    it("Stop rebalance basket", async () => {
        ...
        const {
            tokenAccount: nativeAta,
            tx: txs
        } = await getOrCreateNativeMintATA(connection, admin.publicKey, basketPDA)
